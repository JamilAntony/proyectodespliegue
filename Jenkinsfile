        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/JamilAntony/proyectodespliegue.git'
                }
            }
        }
        stage('Build') {
